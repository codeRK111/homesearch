...
const validate = (state) => {
    ...
    if (state.toiletIndian === null || state.toiletIndian === undefined) {
        errors.toiletIndian = " required";
    }
    if (state.toiletWestern === null || state.toiletWestern === undefined) {
...
const PropertySale = ({ state, furnishes, amenities, onSubmit }) => {
    ...
    }, [amenities, state.amenities, state.amenities.length]);
    React.useEffect(() => {
    ...
    }, [furnishes, state.furnishes, state.furnishes.length]);

				...
				<Box mt="2rem">
					<Grid container spacing={3}>
						<Grid item xs={12} md={9}>
							...
							<Box mt="3rem">
								<h2
									className={clsx(globalClasses.colorPrimary)}
								>
									Explore Nearby Area
								</h2>
							</Box>
							...
							>
								{nearByAreas.map((c, i) => (
									<Box
										ml="0.5rem"
										key={i}
										className={globalClasses.smTopMargin}
									>
								...
								<Grid container spacing={1}>
									...
									<Grid item xs={12} md={6}>
										<Typography variant={'caption'}>
											...
											society. The place is really
											amazing. Gardens are well maintained
											and roads are really cleaned all the
											time. The management has always
											,maintained the decorum.
										</Typography>
									</Grid>
								</Grid>
							</Box>
